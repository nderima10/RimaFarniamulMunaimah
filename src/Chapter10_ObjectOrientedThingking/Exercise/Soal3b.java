...
public class Soal3b {
    ...
    public static boolean isEven(Soal3b myInteger) {
        return myInteger.isEven();
    }
    public static boolean isOdd(Soal3b myInteger) {
        return myInteger.isOdd();
    }
    public static boolean isPrime(Soal3b myInteger) {
    ...
    public boolean equals(Soal3b myInteger) {
