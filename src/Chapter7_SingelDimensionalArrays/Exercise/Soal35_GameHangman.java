...
public class Soal35_GameHangman {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Do you wand to guess another word? Enter y or n>");
            play = input.next();

        } while (play.charAt(0) == 'y');
    }
    public static char[] getWord() {
        String[] words = {"write","that","program","monkey","rooster","dog","pig","rat","ox","tige","rabbit","dragon",
                "snack","hourse","sheep"};
    ...
    public static boolean isWordFinished(char[] blanks) {
        for (char e : blanks) {
            if (e == '*')
                return false;
        }
    ...
    public static void print (int m, char guess) {
        ...
        switch (m) {
            case 1 -> System.out.println("is already ini the word");
